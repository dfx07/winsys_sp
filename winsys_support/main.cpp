...
int main()
{
    ...
    std::string temp = "1233435626";
    std::string temp2 = "concac";
    buff.set(temp.c_str(), temp.length());

    buff2.set(temp2.c_str(), temp2.length());


    buff += buff2;

    char* text = (char*)buff.data();
